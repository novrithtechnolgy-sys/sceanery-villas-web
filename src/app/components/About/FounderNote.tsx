    ...
    <section className="bg-white py-[32px] md:py-[64px]">
      <Container>
        <div className="grid items-center md:gap-10 md:grid-cols-2 lg:gap-16 xl:gap-20">
          <h2 className="md:hidden font-heading text-[22px] md:text-[32px] xl:text-[38px] font-bold md:leading-[42px] xl:leading-[48px] tracking-[-0.5px] text-gray-900 text-center md:text-left mb-8">
          ...
          <div className="max-w-[650px] order-2 md:order-1">
            ...
            {/* Heading */}
            <h2 className="md:block hidden font-heading text-[22px] md:text-[32px] xl:text-[38px] font-bold md:leading-[42px] xl:leading-[48px] tracking-[-0.5px] text-gray-900 text-center md:text-left">
              <span className="text-gray-900">
                A Note
              </span>{" "}
              <span className="text-[#FF751F]">
            ...
            {/* Founder Message */}
            <div className="mt-4 font-body font-regular text-[14px] leading-[26px] text-black md:mt-8 md:text-[16px] lg:leading-[30px] text-center md:text-left">
              <p>
            ...
            <div className="mt-4 md:mt-6">
              <p className="font-body text-[16px] font-bold text-gray-900 md:text-[20px] text-center md:text-left">
                Shiral De Silva
              </p>

              <p className="mt-1 font-body text-[14px] text-gray-800 md:text-[16px] text-center md:text-left">
          ...
          <div className="relative w-full justify-end md:flex order-1">
            <div className="relative h-[320px] w-full overflow-hidden rounded-[24px] md:h-[500px] md:rounded-[26px] lg:h-[560px] xl:h-[600px] xl:max-w-[575px]">
              <Image
