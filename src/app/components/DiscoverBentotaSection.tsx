    ...
    <div className={`${base} ${size}`}>
      ...
      <div className=" absolute left-4 md:left-7 right-7 bottom-7 text-white">
        <div className="flex items-center gap-3">
          ...
          <h3 className="font-body text-[18px] md:text-[20px] xl:text-[24px] font-semibold leading-none">{item.title}</h3>
        </div>
        <p className="font-body mt-2 text-[15px] md:text-[18px] text-white/85 leading-6 max-w-[420px]">
          {item.subtitle}
        </p>
      </div>
    </div>
